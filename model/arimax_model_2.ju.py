...
df_raw = df_raw.drop(columns=["resale_price", "floor_area_sqm", "price_per_sqm"])
df_raw
...
rmse = mean_squared_error(y_test_price, predicted_price, squared=False)
...
plt.plot(y_train.index, np.exp(y_train), label="Train")
